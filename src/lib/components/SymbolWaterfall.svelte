<script lang="ts">
  ...
  import { DETECTOR_HOP_SAMPLES, intensityToRgb, ringSpans, WATERFALL_AHEAD_TRIM, WATERFALL_HISTORY_SECONDS, WATERFALL_MAX_RING_PIXELS, WATERFALL_SAMPLES_PER_CSS_PIXEL, WATERFALL_STALL_FREE_RUN_SECONDS, waterfallPixelAdvance } from '../audio/waterfall';
