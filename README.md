...
3. Both devices record their microphones continuously. Stop the partner, then save **experiment WAV** and **experiment results** before leaving. Prefer the partner recording for receiver analysis. **Load experiment WAV** and **Replay experiment** recompute measurements without accessing audio hardware or changing environmental factors.
